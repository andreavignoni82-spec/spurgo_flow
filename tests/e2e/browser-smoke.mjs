...
assert.ok((await page.evaluate(() => caches.keys())).includes('spurgoflow-v8-0.0-alpha.1-hotfix1'), 'hotfix service-worker cache must exist');
assert.deepEqual(fatalErrors, []);
await mkdir('artifacts', { recursive: true });
await page.screenshot({ path: 'artifacts/spurgo-flow-v8-hotfix1.png', fullPage: true });
await browser.close();
