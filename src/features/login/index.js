...
export const loginFeature={
  ...
  async mount(container,c){
    ...
    form.onsubmit=async e=>{
      ...
      try{
        const identity=await c.services.auth.login(username,password);
        await c.router.navigate(identity.role==='operator'?'operator':'dashboard');
