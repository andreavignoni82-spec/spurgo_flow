...
export class OperatorsService {
  ...
  createOperator(input){const t=this.clock();return this.repository.create({...input,id:this.idFactory(),username:normalizeUsername(input.username),active:input.active!==false,createdAt:t,updatedAt:t});}
